...
/**
 * Velocity config migration işleminin sonucunu temsil eder.
 *
 * @author AtomGuard Team
 * @version 2.0.0
 */
public class VelocityMigrationResult {
    ...
    private VelocityMigrationResult(Builder builder) {
    ...
    public static class Builder {
        ...
        public VelocityMigrationResult build() {
            return new VelocityMigrationResult(this);
        }
    }
}
